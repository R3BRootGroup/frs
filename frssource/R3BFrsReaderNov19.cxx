...
Bool_t R3BFrsReaderNov19::Read()
{
    ...
    /*
        ...
        new ((*fArrayTpc)[fArrayTpc->GetEntriesFast()]) R3BTpcMappedData(0, tpc_ae, tpc_le, tpc_re, tpc_dt, tpc_lt,
       tpc_rt);
        ...
        new ((*fArrayTpc)[fArrayTpc->GetEntriesFast()]) R3BTpcMappedData(1, tpc_ae, tpc_le, tpc_re, tpc_dt, tpc_lt,
       tpc_rt);
    */
    ...
    /*
       ...
       tpc_rt);
        ...
        new ((*fArrayTpc)[fArrayTpc->GetEntriesFast()]) R3BTpcMappedData(2, tpc_ae, tpc_le, tpc_re, tpc_dt, tpc_lt,
       tpc_rt);
        ...
        new ((*fArrayTpc)[fArrayTpc->GetEntriesFast()]) R3BTpcMappedData(3, tpc_ae, tpc_le, tpc_re, tpc_dt, tpc_lt,
       tpc_rt);
