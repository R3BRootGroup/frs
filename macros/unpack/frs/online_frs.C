...
void online_frs()
{
    ...
    R3BWhiterabbitMasterReader* unpackWRM =
        new R3BWhiterabbitMasterReader((EXT_STR_h101_WRMASTER*)&ucesb_struct.wrm, offsetof(EXT_STR_h101, wrm), 0x100);

    R3BFrsReaderNov19* unpackfrs =
        new R3BFrsReaderNov19((EXT_STR_h101_FRS*)&ucesb_struct.frs, offsetof(EXT_STR_h101, frs));

    FrsTpcReader* unpacktpc = new FrsTpcReader((EXT_STR_h101_TPC*)&ucesb_struct.tpc, offsetof(EXT_STR_h101, tpc));

    VftxSciReader* unpackvftx =
        new VftxSciReader((EXT_STR_h101_frssci*)&ucesb_struct.vftx, offsetof(EXT_STR_h101, vftx));

    FrsMusicReader* unpackmusic =
        new FrsMusicReader((EXT_STR_h101_FRSMUSIC*)&ucesb_struct.music, offsetof(EXT_STR_h101, music));
