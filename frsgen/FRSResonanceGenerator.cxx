...
void FRSResonanceGenerator::ProjectileExcitation(FairPrimaryGenerator* primGen,
                                                 Double_t mres,
                                                 Double_t wres,
                                                 Double_t mnucleon)
{
...
void FRSResonanceGenerator::TargetExcitation(FairPrimaryGenerator* primGen,
                                             Double_t mres,
                                             Double_t wres,
                                             Double_t mnucleon)
{
...
void FRSResonanceGenerator::TargetExcitation2pi(FairPrimaryGenerator* primGen,
                                                Double_t mres,
                                                Double_t wres,
                                                Double_t mnucleon)
{
