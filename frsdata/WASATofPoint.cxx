...
// -----   Default constructor   -------------------------------------------
WASATofPoint::WASATofPoint() : FairMCPoint() {
  fDetCopyID = -1;
...
WASATofPoint::WASATofPoint(Int_t trackID, Int_t detID, Int_t detCopyID, TVector3 posIn, 
...
void WASATofPoint::Print(const Option_t* opt) const {
  cout << "-I- WASATofPoint: STS Point for track " << fTrackID 
