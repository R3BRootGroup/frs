...
R3BFrsMappedData::R3BFrsMappedData()
    : fAccTrig(0),
      ...
      fSCI01(0),
      fSCI02(0),
      fSCI21RT(0),fSCI41RT(0),fSCI42RT(0),fSCI43RT(0),
      fSCI21LT(0),fSCI41LT(0),fSCI42LT(0),fSCI43LT(0),
      fSCI21RE(0),fSCI41RE(0),fSCI42RE(0),fSCI43RE(0),
      fSCI21LE(0),fSCI41LE(0),fSCI42LE(0),fSCI43LE(0)
{
}
...
R3BFrsMappedData::R3BFrsMappedData(const R3BFrsMappedData& right)
    : fAccTrig(right.fAccTrig),
      ...
      fSCI01(right.fSCI01),
      fSCI02(right.fSCI02),
      fSCI21RT(right.fSCI21RT),fSCI41RT(right.fSCI41RT),fSCI42RT(right.fSCI42RT),fSCI43RT(right.fSCI43RT),
      fSCI21LT(right.fSCI21LT),fSCI41LT(right.fSCI41LT),fSCI42LT(right.fSCI42LT),fSCI43LT(right.fSCI43LT),
      fSCI21RE(right.fSCI21RE),fSCI41RE(right.fSCI41RE),fSCI42RE(right.fSCI42RE),fSCI43RE(right.fSCI43RE),
      fSCI21LE(right.fSCI21LE),fSCI41LE(right.fSCI41LE),fSCI42LE(right.fSCI42LE),fSCI43LE(right.fSCI43LE)
{
}
