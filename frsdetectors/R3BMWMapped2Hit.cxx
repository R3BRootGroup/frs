...
void R3BMWMapped2Hit::Exec(Option_t* option)
{
    ...
    Reset();
    if (fMw11MappedDataCA)
        MakeHit(fMw11MappedDataCA);
    if (fMw21MappedDataCA)
        MakeHit(fMw21MappedDataCA);
    if (fMw22MappedDataCA)
        MakeHit(fMw22MappedDataCA);
    if (fMw31MappedDataCA)
        MakeHit(fMw31MappedDataCA);
    if (fMw51MappedDataCA)
        MakeHit(fMw51MappedDataCA);
    if (fMw71MappedDataCA)
        MakeHit(fMw71MappedDataCA);
    if (fMw81MappedDataCA)
        MakeHit(fMw81MappedDataCA);
    if (fMw82MappedDataCA)
        MakeHit(fMw82MappedDataCA);
}
